...
└── demo/
    ...
    └── 03-rspec/        # Base completa (AGENTS.md, skills, subagents) — rodada r-spec
```
...
| 3. r-spec | `03-rspec/` | Artefatos aprovados, sensores por fase, rastro versionado |

As três bases partem da mesma aplicação **zerada** (React + Vite + Tailwind,
Express + TypeScript, Vitest + Playwright, sem nenhuma feature); diferem
apenas no que o agente enxerga — a `03-rspec/` leva AGENTS.md, as skills na
